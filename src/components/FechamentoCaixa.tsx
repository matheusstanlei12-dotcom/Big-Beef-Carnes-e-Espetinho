    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem', height: 'calc(100vh - 160px)', overflowY: 'auto', paddingRight: '4px' }}>
      ...
      <div style={{ background: 'rgba(212,175,55,0.04)', border: '2px solid rgba(212,175,55,0.2)', borderRadius: '20px', padding: '1.5rem' }}>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <input
            ...
            style={{ width: '100%', background: dinheiroGaveta ? 'rgba(212,175,55,0.05)' : 'rgba(255,255,255,0.03)', border: `2px solid ${dinheiroGaveta ? '#dc2626' : 'rgba(255,255,255,0.1)'}`, borderRadius: '12px', padding: '1rem', color: '#fff', fontSize: '1.8rem', fontWeight: 900, textAlign: 'center', outline: 'none', transition: '0.2s' }}
          />
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', paddingBottom: '2rem' }}>
        <button onClick={handleGerarRelatorio}
          style={{ background: 'rgba(212,175,55,0.1)', border: '2px solid rgba(212,175,55,0.4)', borderRadius: '14px', color: '#dc2626', padding: '1rem', fontWeight: 900, fontSize: '0.85rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
