              ...
              {selectedMesa.status === 'livre' ? (
                ...
                <>
                  ...
                  {showTransferModal && (
                    ...
                    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(2, 6, 23, 0.85)', backdropFilter: 'blur(10px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
                  ...
                  <div className="d-flex justify-between items-center mb-4">
                    ...
                    <div>
                        ...
                        <div className="text-muted">Total: R$ {formatCurrency(currentMesaTotal)}</div>
