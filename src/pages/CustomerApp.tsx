...
export const CustomerApp = () => {
  ...
  if (showAvaliacao) {
    return (
      <div style={{ minHeight: '100dvh', backgroundColor: 'var(--bg-color)', padding: '2rem 1.5rem', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
        ...
        <p className="text-muted text-center" style={{ marginBottom: '2rem' }}>Sua mesa foi finalizada. O que achou da experiência no Big Bifee?</p>
  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{ 
        padding: '0.8rem 1.25rem', backgroundColor: 'rgba(0, 0, 0, 0.4)', borderBottom: '1px solid rgba(255, 255, 255, 0.05)',
