# Big Bifee - Sistema de Gestão para Bares e Restaurantes

Sistema completo de gestão para estabelecimentos, com foco em autoatendimento via QR Code, controle de produção (KDS), gestão de equipe e frente de caixa.
